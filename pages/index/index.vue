<template>
	<view class="index" :style="{ paddingTop: statusHeight + navHeight + 'px' }">
		<view class="header" :style="{ height: statusHeight + 'px' }">
			...
			<view class="container" :style="{ height: (windowBottom ? (contentHeight-windowBottom) : contentHeight) + 'px', overflow: 'auto' }">
				...
				<view class="list_item bg-white mt-[30rpx] rounded-[20rpx]">
					<view
						...
						<view class="list_icon w-[36rpx] h-[36rpx] mr-[8rpx]">
							<image class="h-full w-full" src="/static/icons/公司介绍@2x.png" mode="widthFix" />
						</view>
						<view>
							<view class="z-1 relative list_title_one">
								公司介绍
								<image class="z-0 w-[90rpx] h-[13rpx] absolute bottom-0 left-0"
									src="/static/icons/Vector 10@2x(1).png" />
							</view>
						</view>
					</view>
           ...
           text-[30rpx] text-[#333]">
				...
				<view class="list_item bg-white mt-[30rpx] rounded-[20rpx]">
					<view
						class="list_title flex items-center h-[74rpx] p-[20rpx]  rounded-[20rpx] rounded-bl-none  rounded-br-none border-[2rpx] border-solid border-[rgba(51,51,51,0.05)]">
						<view class="list_icon w-[36rpx] h-[36rpx] mr-[8rpx]">
							<image class="h-full w-full" src="/static/icons/签约流程@2x.png" mode="widthFix" />
						</view>
						<view>
							<view class="z-1 relative list_title_one">
								签约流程
					...
					<view class="content mt-[42rpx] p-[20rpx] pb-[50rpx]">
						<view class="relative flex">
							...
							<image class="absolute top-0 right-0 w-[630rpx] h-[40rpx]"
								src="/static/icons/线上流程@2x.png" />
						</view>
				...
				<view class="list_item bg-white mt-[30rpx] rounded-[20rpx]">
					<view
						class="list_title flex items-center h-[74rpx] p-[20rpx]  rounded-[20rpx] rounded-bl-none  rounded-br-none border-[2rpx] border-solid border-[rgba(51,51,51,0.05)]">
						<view class="list_icon w-[36rpx] h-[36rpx] mr-[8rpx]">
							<image class="h-full w-full" src="/static/icons/服务项目@2x.png" mode="widthFix" />
						</view>
						<view>
							<view class="z-1 relative list_title_one">
								服务项目
					...
					<view class="content mt-[32rpx] p-[20rpx] pb-[50rpx] pt-0">
						...
						<view v-for="(item,index) in ProductList" @click="toProjectDetail(item)" :key="item.id"
							...
							<view class="w-[140rpx] mr-[30rpx] flex justify-center items-center">
								<image class="w-[140rpx] h-[104rpx] rounded-[8rpx]"
									:src="`https://picsum.photos/70/7${index}`" />
							</view>
				...
				<view class="list_item bg-white mt-[30rpx] rounded-[20rpx] mb-[30rpx]">
					<view
						class="list_title flex items-center h-[74rpx] p-[20rpx]  rounded-[20rpx] rounded-bl-none  rounded-br-none border-[2rpx] border-solid border-[rgba(51,51,51,0.05)]">
						<view class="list_icon w-[36rpx] h-[36rpx] mr-[8rpx]">
							<image class="h-full w-full" src="/static/icons/附近公司@2x.png" mode="widthFix" />
						</view>
						<view>
							<view class="z-1 relative list_title_one">
								附近公司
